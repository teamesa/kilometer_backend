...
public class FileUtils {
    ...
    public static final String PHOTO_FILE_EXTENSION_REGEX = ".(png|jpeg|jpg|gif)$";
    ...
    public static String getFileName(String originFileName) {
        return LocalDateTime.now().format(DateTimeFormatter.ofPattern("HHmmss"))+"-"+originFileName ;
    }
